    ...
    <div className='flex flex-col h-40 justify-center items-center'>
      ...
      <div>
        <form action="">
          ...
          <input type="submit" value="search" className='hover:text-black hover:font-bold hover:bg-white  ml-5 rounded-lg p-1 w-16 text-white bg-slate-900 cursor-pointer' />
        </form>
      </div>
    </div>
  </>;
